module systolic_array_engine_os #(
    ...
    output logic                       acc_bram_en_o,
    output logic                       acc_bram_we_o,
    output logic        [  ADDR_W-1:0] acc_bram_addr_o,
  ...
  logic                       weight_valid_w[COLS];
  logic                       acc_clear_w;
  logic signed [   ACC_W-1:0] array_acc_w[ROWS][COLS];

  logic                       storer_valid_w;
  logic        [  ADDR_W-1:0] storer_addr_w;
  logic signed [   ACC_W-1:0] storer_data_w[ROWS];
